...
- Used Parcelable but didn't use the lib
...
* [x] List anything else that you can get done to improve the app functionality!
  * [x] Used SharedPreferences to store filter settings

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/tejaldev/ArticleSearch/blob/master/ArticleSearch.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
